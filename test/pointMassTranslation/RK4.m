function [X] = RK4(dynamics, t, dt, X, obj, varargin)
...
% COEFFICIENTS
k1 = dynamics(t,      X,           obj, varargin{:});
k2 = dynamics(t+dt/2, X + dt*k1/2, obj, varargin{:});
k3 = dynamics(t+dt/2, X + dt*k2/2, obj, varargin{:});
k4 = dynamics(t+dt,   X + dt*k3,   obj, varargin{:});
